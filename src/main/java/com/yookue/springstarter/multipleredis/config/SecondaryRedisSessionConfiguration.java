...
@ConditionalOnAllProperties(value = {
    ...
    @ConditionalOnProperty(prefix = SecondaryRedisAutoConfiguration.PROPERTIES_PREFIX, name = "session.enabled", havingValue = "true", matchIfMissing = true)
})
...
public class SecondaryRedisSessionConfiguration {
    ...
    public RedisIndexedSessionRepository sessionRepository(@Qualifier(value = SecondaryRedisAutoConfiguration.OBJECT_REDIS_TEMPLATE) @Nonnull RedisTemplate<Object, Object> template) {
